...
Adding a Sync to Nango is quick & easy. If you have not read the
[core concepts](/nango-sync/use-nango/core-concepts) yet please do so first:
From here on out we assume you are familiar with Syncs and how they work
