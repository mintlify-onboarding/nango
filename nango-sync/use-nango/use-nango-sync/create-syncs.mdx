...
Adding a Sync to Nango is quick & easy. If you have not read the [core concepts](/nango-sync/use-nango/core-concepts) yet please do so first: From here on out we assume you are familiar with Syncs and how they work together with your application.
...
If you want to see some examples of them in action take a look at the [real world examples](/nango-sync/real-world-examples) page.
