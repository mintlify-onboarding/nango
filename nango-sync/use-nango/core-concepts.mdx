...
Learn more about
[creating & managing Syncs](/nango-sync/use-nango/sync-all-options) or look at
the [full example of a Sync](#exampleSync) below.
...
- You can [attach Metadata](/nango-sync/use-nango/sync-metadata) to every record
  Nango syncs in (e.g. user id, account id)
