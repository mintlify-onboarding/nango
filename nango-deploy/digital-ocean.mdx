---
title: "Deploy Nango to Digital Ocean (Droplet)"
---

info

Your should read the [self-hosting instructions](/nango-deploy/oss-instructions) before deploying to production.
