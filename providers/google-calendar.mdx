...
Follow our [quickstart](/quickstart) to add an OAuth integration with the Google Calendar API in 5 minutes.
...
Please check the main [Google OAuth API wiki](/providers/google) here for details on how to register an OAuth app with Google.
