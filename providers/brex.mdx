...
Follow our [quickstart](/quickstart) to add an OAuth integration with Brex in 5 minutes.
...
* Brex offers a staging system to test your apps, you will get access when you register as a partner. Staging details are [here](https://developer.brex.com/docs/partner%5Fauthentication/#api-servers)